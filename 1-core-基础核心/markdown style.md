# Google Markdown 文档风格指南

参考[style.md](#google styleguide/docguide/style.md)
[Markdown](#markdown.md)

Markdown 的强大多数在于编写纯文本文件并得到很好的格式化输出的能力。为其他作者保持
一个干净的书写环境，你的 Mardown 文件应该尽可能的简单并于真个资料库保持一致。

We seek to balance three goals:

我们力求平衡如下三个目标：

1. 源文件是可读的并且可移植的。 Source text is readable and portable.
2. Markdown 文件可以长期跨团队维护。 *Markdown files are maintainable over time and across teams.*
3. 语法应该简单并且易记。*The syntax is simple and easy to remember.*
4567890
