...
建立社群，深度思考、话题探讨、协同学习、互相启发、探索知识及智能本质，挖掘整合利用每个人的智能，**自由组团**定位贡献力量，通过开放合作共赢的方式，形成协同机制，发挥团队力量进行知识发现、训练实现智能，集思广益，**共赢**。产出相关理论及技术积累（智能结构理论、知识体系、认知模型、知识库、工具），成立**从心盟（开放合作共赢自组织的联盟）**，为智能时代做准备！  
...
1. idea 文档完善：起源初心、目的意义、价值、战略、愿景、路线；
1. 创业计划书编写：合伙协议、章程、产品、商业推动、具体化；
1. GitHub 教程：初步协同机制，社群协同机制；
1. 初步元理论：基本原则、术语定义、认知模型、知识智能本质、初步框架；
1. 知识、社群、资源，统一协同管理，组建核心团队，需求投资合作；
1. 洗脑、放空、统一认知（价值意义、愿景、原则、可能性、积极性、一种信仰、爱好、兴趣）！
1. 知识智能助理工具开发，功能列表、技术路线、架构设计
1. 自由定位分工干活，迭代完善！
